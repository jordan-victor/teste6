...
function carrosel(){
    ...
    var imagens = setInterval(()=>{
        ...
        if (soma == 1){
            ...
            var frases = document.querySelector("#FraseBonitinha").innerHTML = "Temos opções bem diferenciadas de Burgueres!"
        }
        else if (soma == 5){
...
function somar(){
    ...
    alert("Adicione algo à lista")
        ...
        var botãoPedir = document.getElementById("pedir").style.display = "block"
    }
